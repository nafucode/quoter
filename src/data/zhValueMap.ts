...
export const ZH_VALUE_MAP: [RegExp, string][] = [
  ...
  [/facial\s*and\s*fingerprint\s*recognition\s*with\s*floor\s*access\s*control\.?/gi, '人脸和指纹识别楼层权限控制'],
  [/face\s*recognition/gi,        '人脸识别'],
  [/facial\s*recognition/gi,      '人脸识别'],
  [/fingerprint\s*recognition/gi, '指纹识别'],
  [/floor\s*access\s*control/gi,  '楼层权限控制'],
  [/4g\s*iot\s*\(?internet\s*of\s*things\)?/gi, '4G物联网'],
  [/\biot\b/gi,                   '物联网（IoT）'],
  [/\bcctv\b/gi,                 'CCTV监控'],
