...
export const ES_VALUE_MAP: [RegExp, string][] = [
  ...
  [/facial\s*and\s*fingerprint\s*recognition\s*with\s*floor\s*access\s*control\.?/gi, 'Reconocimiento facial y de huella dactilar con control de acceso por piso'],
  [/face\s*recognition/gi,        'Reconocimiento facial'],
  [/facial\s*recognition/gi,      'Reconocimiento facial'],
  [/fingerprint\s*recognition/gi, 'Reconocimiento de huella dactilar'],
  [/floor\s*access\s*control/gi,  'Control de acceso por piso'],
  [/4g\s*iot\s*\(?internet\s*of\s*things\)?/gi, 'Internet de las cosas 4G'],
  [/\biot\b/gi,                   'IoT (Internet de las cosas)'],
