...
export const FR_VALUE_MAP: [RegExp, string][] = [
  ...
  [/facial\s*and\s*fingerprint\s*recognition\s*with\s*floor\s*access\s*control\.?/gi, 'Reconnaissance faciale et empreinte digitale avec controle d acces aux etages'],
  [/face\s*recognition/gi, 'Reconnaissance faciale'],
  [/facial\s*recognition/gi, 'Reconnaissance faciale'],
  [/fingerprint\s*recognition/gi, 'Reconnaissance par empreinte digitale'],
  [/floor\s*access\s*control/gi, 'Controle d acces aux etages'],
  [/4g\s*iot\s*\(?internet\s*of\s*things\)?/gi, 'Internet des objets 4G'],
  [/\biot\b/gi, 'IoT (Internet des objets)'],
  [/\bcctv\b/gi, 'CCTV'],
