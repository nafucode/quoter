...
export const translations = {
  en: {
    ...
    warrantySuffix: 'months from the date the goods depart from the port of shipment.',
    ...
    specDoor1st: 'Base Floor Door Decoration',
    specDoorOther: 'Other Floors Door Decoration',
    specDoorJambBase: 'Base Floor Door Jamb',
    specDoorJambOther: 'Other Floors Door Jamb',
    specCopLop: 'COP/LOP',
  ...
  zh: {
    ...
    paymentTerm: '二、付款方式：',
    warranty: '三、质保：',
    warrantySuffix: '个月（自货物离开发货港之日起算）。',
    ...
    specDoorJambBase: '基站层门套',
    specDoorJambOther: '其他层门套',
    specCopLop: 'COP/LOP',
    specIncluded: '含',
  ...
  es: {
    ...
    warrantySuffix: 'meses a partir de la fecha en que la mercancía salga del puerto de embarque.',
    ...
    specFloors: 'Pisos/Paradas/Puertas',
    ...
    specDoor1st: 'Decoración puerta piso base',
    specDoorOther: 'Decoración puertas otros pisos',
    specDoorJambBase: 'Jamba puerta piso base',
    specDoorJambOther: 'Jamba puertas otros pisos',
    specCopLop: 'COP/LOP',
  ...
  pt: {
    ...
    warrantySuffix: 'meses a partir da data em que as mercadorias saírem do porto de embarque.',
    ...
    specFloors: 'Andares/Paradas/Portas',
    ...
    specDoor1st: 'Decoração porta piso base',
    specDoorOther: 'Decoração portas demais andares',
    specDoorJambBase: 'Batente porta piso base',
    specDoorJambOther: 'Batente portas demais andares',
    specCopLop: 'COP/LOP',
  ...
  fr: {
    ...
    warrantySuffix: 'mois à compter de la date de départ des marchandises du port d\'expédition.',
    ...
    specFloors: 'Niveaux/Arrêts/Portes',
    ...
    specDoor1st: 'Décoration porte étage de base',
    specDoorOther: 'Décoration portes autres étages',
    specDoorJambBase: 'Jambage porte étage de base',
    specDoorJambOther: 'Jambage portes autres étages',
    specCopLop: 'COP/LOP',
    specIncluded: 'Inclus',
  ...
  vi: {
    ...
    warrantySuffix: 'tháng kể từ ngày hàng rời cảng xếp hàng.',
    ...
    specDoor1st: 'Trang trí cửa tầng cơ sở',
    specDoorOther: 'Trang trí cửa các tầng khác',
    specDoorJambBase: 'Khung bao cửa tầng cơ sở',
    specDoorJambOther: 'Khung bao cửa các tầng khác',
    specCopLop: 'COP/LOP',
  ...
  km: {
    ...
    warrantySuffix: 'ខែ គិតចាប់ពីកាលបរិច្ឆេទទំនិញចាកចេញពីកំពង់ផែដឹកជញ្ជូន។',
    ...
    specDoor1st: 'ការតុបតែងទ្វារជាន់មូលដ្ឋាន',
    specDoorOther: 'ការតុបតែងទ្វារជាន់ផ្សេងៗ',
    specDoorJambBase: 'ស៊ុមទ្វារជាន់មូលដ្ឋាន',
    specDoorJambOther: 'ស៊ុមទ្វារជាន់ផ្សេងៗ',
    specCopLop: 'COP/LOP',
  ...
  ar: {
    ...
    warranty: 'III. الضمان:',
    warrantySuffix: 'شهرا من تاريخ مغادرة البضاعة ميناء الشحن.',
    ...
    specFloors: 'الطوابق/التوقفات/الأبواب',
    ...
    specDoor1st: 'تشطيب باب الطابق الأساسي',
    specDoorOther: 'تشطيب أبواب الطوابق الأخرى',
    specDoorJambBase: 'حلق باب الطابق الأساسي',
    specDoorJambOther: 'حلق أبواب الطوابق الأخرى',
    specCopLop: 'COP/LOP',
    specIncluded: 'مشمول',
  ...
  ru: {
    ...
    warrantySuffix: 'месяцев с даты отправления товара из порта отгрузки.',
    ...
    specFloors: 'Этажи/Остановки/Двери',
    ...
    specDoor1st: 'Отделка двери базового этажа',
    specDoorOther: 'Отделка дверей других этажей',
    specDoorJambBase: 'Обрамление двери базового этажа',
    specDoorJambOther: 'Обрамление дверей других этажей',
    specCopLop: 'COP/LOP',
