...
export const VI_VALUE_MAP: [RegExp, string][] = [
  ...
  [/facial\s*and\s*fingerprint\s*recognition\s*with\s*floor\s*access\s*control\.?/gi, 'Nhận dạng khuôn mặt và vân tay với kiểm soát truy cập tầng'],
  [/face\s*recognition/gi, 'Nhận dạng khuôn mặt'],
  [/facial\s*recognition/gi, 'Nhận dạng khuôn mặt'],
  [/fingerprint\s*recognition/gi, 'Nhận dạng vân tay'],
  [/floor\s*access\s*control/gi, 'Kiểm soát truy cập tầng'],
  [/4g\s*iot\s*\(?internet\s*of\s*things\)?/gi, 'Internet vạn vật 4G'],
  [/\biot\b/gi, 'IoT (Internet vạn vật)'],
  [/\bcctv\b/gi, 'CCTV'],
